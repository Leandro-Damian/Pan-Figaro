...
const blurHeader = () =>{
    ...
    // When the scroll is greater than 50 viewport height, add the blur-header cñass to the header tag
...
sr.reveal(`.home__image, .footer__img-1, .footer__`, {rotate: {z: -15} })
